...
br.addheaders = [('user-agent', 'Mozilla/5.0 (Linux; Android 9; Redmi 6) AppleWebKit/537.36) [FBAN/FB4A;FBAV/106.0.0.26.68;FBBV/45904160;FBDM/{density=3.0,width=1080,height=1920};FBLC/it_IT;FBRV/45904160;FBCR/PosteMobile;FBMF/asus;FBBD/asus;FBPN/com.facebook.katana;FBDV/ASUS_Z00AD;FBSV/5.0;FBOP/1;FBCA/x86:armeabi-v7a;]')]
...
oks = []
id = []
print 'AUTHOR :  Nyeem Hassan'
print 'FACEBOOK :demon.king.wish'
print 'GITHUB : https://github.com/N4Y66M/'
CorrectUsername = 'N4Y66M'
CorrectPassword = 'H455N'
loop = 'true'
while loop == 'true':
...
name = raw_input('\x1b[1;92m\x1b[1;92m Enter Your Name:Nayeem ')
os.system('xdg-open ')
